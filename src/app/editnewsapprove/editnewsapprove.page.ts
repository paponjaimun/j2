...
@Component({
  selector: 'app-editnewsapprove',
  templateUrl: './editnewsapprove.page.html',
  styleUrls: ['./editnewsapprove.page.scss'],
})
export class EditnewsapprovePage implements OnInit,OnDestroy {
