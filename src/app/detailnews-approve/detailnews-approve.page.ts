...
@Component({
  selector: 'app-detailnews-approve',
  templateUrl: './detailnews-approve.page.html',
  styleUrls: ['./detailnews-approve.page.scss'],
})
export class DetailnewsApprovePage implements OnInit {
  ...
  edit(){ 
    this.navCtrl.navigateForward(['/tabsApprove/status-approve/detailnews-approve/editnewsapprove', {       
