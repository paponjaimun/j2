...
@Component({
  selector: 'app-approve-news',
  templateUrl: './approve-news.page.html',
  styleUrls: ['./approve-news.page.scss'],
})
export class ApproveNewsPage implements OnInit {
  ...
  goDetailNotallow(n: any){     
    console.log(n);   
    this.navCtrl.navigateForward(['/tabsApprove/approve-news/approve-news-detail', {       
